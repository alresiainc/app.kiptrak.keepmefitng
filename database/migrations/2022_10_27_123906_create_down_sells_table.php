...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('down_sells', function (Blueprint $table) {
            ...
            $table->string('downsell_heading')->nullable(); //
            $table->string('downsell_subheading')->nullable(); //
            $table->string('downsell_description')->nullable();

            $table->string('downsell_setting_id')->nullable();

            $table->string('order_id')->nullable();
            $table->string('product_id')->nullable();

            $table->string('downsell_discount_type')->nullable();
            $table->string('downsell_discount')->nullable();
