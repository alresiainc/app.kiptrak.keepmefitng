...
<head>
    ...
    <title>{{ $message ?? 'WELCOME TO PAGE' }}</title>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 text-center text-white">
                ...
                <a href="/login" class="mt-3"
                    style="background-color: #EF3B2D;color: #ffffff;padding: 10px 20px;border-radius: 5px;text-decoration: none;font-size: 20px;font-weight: 900;">
                    Login
                </a>
            </div>
        </div>
