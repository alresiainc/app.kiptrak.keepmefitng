...
<body>
    ...
    <script type="text/javascript" charset="utf8"
        src="https://cdn.datatables.net/buttons/2.2.3/js/dataTables.buttons.min.js"></script><!--imp-->
    <script type="text/javascript" charset="utf8" src="//cdn.datatables.net/buttons/2.2.3/js/buttons.bootstrap5.min.js">
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('.custom-table').DataTable({
                "bSort": false,
                "ordering": false, // This ensures ordering is disabled.
                "order": [], // Ensures no initial sorting.
                dom: 'Blfrtip',
                buttons: [
