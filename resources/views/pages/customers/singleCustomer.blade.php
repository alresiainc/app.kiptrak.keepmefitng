...
@section('title')View Customer @endsection
@section('content')
            ...
            <div class="card-body pt-3">
                ...
                <div class="d-lg-flex d-grid align-items-center float-start">
                  <div>
                    @if (isset($customer->profile_picture))
                        ...
                        data-fancybox
                        > 
                        <img src="{{ asset('/storage/customer/'.$customer->profile_picture) }}" width="100" class="img-thumbnail img-fluid"
                        alt="Photo"></a>
                    @else
                    <img src="{{ asset('/storage/customer/person.png') }}" width="100" class="img-thumbnail img-fluid"
                    alt="Photo"> 
                    @endif
              ...
              <div class="row g-3">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="lead">@if (isset($customer->city)){{ $customer->city }} @else N/A @endif</div>
                </div>
               
                <div class="col-lg-3">
                  <label for="">Address</label>
                  <div class="lead">@if (isset($customer->delivery_address)){{ $customer->delivery_address }} @else N/A @endif</div>
                </div>
