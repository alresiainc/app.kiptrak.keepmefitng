...
@section('title'){{ $customer->firstname }} {{ $customer->lastname }}'s Products Bought @endsection
@section('content')

<main id="main" class="main">

  <div class="pagetitle">
    <h1>{{ $customer->firstname }} {{ $customer->lastname }}'s Products Bought</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('allCustomer') }}">Customers</a></li>
        <li class="breadcrumb-item active">{{ $customer->firstname }} {{ $customer->lastname }}'s Products Bought</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
        ...
        <div class="card">
          ...
          <hr>
            ...
            <div class="table table-responsive">
              <table id="customers-table" class="table custom-table" style="width:100%">
                <thead>
                    <tr>
                        <th>Sale Code</th>
                        <th>Sale Status</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Import Customer CSV File</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div>Download sample customer CSV file <a href="#" class="btn btn-sm rounded-pill btn-primary"><i class="bi bi-download me-1"></i> Download</a></div>
        <div class="mt-3">
