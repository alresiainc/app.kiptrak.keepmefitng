                        ...
                        <article class="card shadow-sm mb-3 text-end">
                            <div onclick="generatePDF()">
                                ...
                                <a href="javascript:void(0);"
                                    class="btn btn-sm text-{{ $thankYou->button_text_align }} fst-{{ $thankYou->button_text_style }} fw-{{ $thankYou->button_text_weight }} fs-{{ $thankYou->button_text_size }}"
                                    style="background-color: {{ $thankYou->button_bg_color }}; color: {{ $thankYou->button_text_color }};"><i
                                        class="bi bi-download text-white"></i> {{ $thankYou->button_text }}</a>
                            </div>
                            <div class="card-body" id="invoice">
                                <header class="d-md-flex text-center">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0"> Order ID: {{ $orderId }} <i class="dot"></i><span
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p class="m-0">
                                            ...
                                            <br> Phone: <span class="customer_phone">{{ $customer->phone_number }},
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div>© <span class="copyright-date">2023</span> <span class="project-name">KipTrak</span>. All
                        rights reserved. </div>
                </div>
            </div>
        </div>
