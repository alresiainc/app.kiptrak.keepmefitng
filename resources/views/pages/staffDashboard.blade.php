  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Staff Dashboard</li>
    ...
    <div class="row">
        ...
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'new') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'pending') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'cancelled') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'delivered_and_remitted') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'delivered_not_remitted') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'total_follow_ups') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'today_follow_ups') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'tomorrow_follow_ups') }}" style="color: inherit;"><div class="text-start">
      ...
      <div class="col-lg-2 col-md-6">
        <div class="card border-right-success card-right-border">
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-start">
              <a href="{{ route('allOrders', 'other_orders') }}" style="color: inherit;"><div class="text-start">
