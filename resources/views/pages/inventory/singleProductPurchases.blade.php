...
@section('title'){{ $product->name }} Purchases Inventory @endsection
...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>{{ $product->name }}, Purchases Inventory</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('inventoryDashboard') }}">Inventory</a></li>
        <li class="breadcrumb-item active">{{ $product->name }}, Purchases Inventory</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
