...
@section('title')In-Stock Products By Other Agents @endsection
...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>In-Stock Products By Other Agents</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('inventoryDashboard') }}">Inventory</a></li>
        <li class="breadcrumb-item active">In-Stock Products By Other Agents</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="users-list-wrapper">
    <div class="users-list-filter px-1">
      <form action="{{ route('inStockProductsByOtherAgentsQuery') }}" method="POST">@csrf
        <div class="row border rounded py-2 mb-2">
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-3">
            <label for="">Select Other Agents</label>
            <fieldset class="form-group">
