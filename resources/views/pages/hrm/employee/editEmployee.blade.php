                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" action="{{ route('editStaffPost', $staff->unique_key) }}"
                                ...
                                <div class="gallery-uploader-wrap">
                                    ...
                                    <label class="uploader-img">
                                        @if (isset($staff->profile_picture))
                                            <img src="{{ asset('/storage/staff/' . $staff->profile_picture) }}"
                                                width="100" class="img-fluid" alt="Upload Photo">
                                        @else
                                            <img src="{{ asset('/storage/staff/person.png') }}" width="100"
                                                class="img-fluid img-circle" alt="Upload Photo">
                                        @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="firstname"
                                        class="form-control @error('firstname') is-invalid @enderror" id=""
                                        value="{{ $firstname }}">
                                    @error('firstname')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="lastname"
                                        class="form-control @error('lastname') is-invalid @enderror" id=""
                                        value="{{ $lastname }}">
                                    @error('lastname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" name="phone_1"
                                        class="form-control @error('phone_1') is-invalid @enderror" placeholder=""
                                        value="{{ $staff->phone_1 }}">
                                    @error('phone_1')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" name="phone_2"
                                        class="form-control @error('phone_2') is-invalid @enderror" placeholder=""
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="country" data-live-search="true"
                                        class="custom-select form-control border @error('country') is-invalid @enderror">

                                        <option value="{{ $staff->country->id }}" selected>{{ $staff->country->name }}
                                        </option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="current_salary"
                                        class="form-control @error('current_salary') is-invalid @enderror" placeholder=""
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="role_id" id="role_id" data-live-search="true"
                                        ...
                                        <option
                                            value="{{ $staff->hasAnyRole($staff->id) ? $staff->role($staff->id)->role->id : '' }}">
