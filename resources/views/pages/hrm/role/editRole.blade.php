                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" action="{{ route('editRolePost', $role->unique_key) }}"
                                method="POST">@csrf
                                <div class="col-md-12">
                                    ...
                                    <div class="row mt-5">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-sm text-white d-none"
                                                ...
                                                data-bs-target="#importModal" data-bs-toggle="modal"
                                                data-bs-placement="auto" data-bs-title="Export Data">
                                        ...
                                        <!--permissions-->
                                        <div>
                                            {{-- @dd($permissions->pluck('slug')->toArray()) --}}
                                                ...
                                                <div class="main-card mb-3 card">
                                                    <div class="card-body">
                                                        ...
                                                        @if (!empty($perm->permissions))
                                                            {{-- @if ($perm->slug == 'order')
                                                                @dd($perm->pluck('slug')->toArray())
                                                            @endif --}}

                                                            @foreach ($perm->permissions as $sub_perm)
                                                                <div class="position-relative form-check form-check-inline">
                                                                    <input type="hidden" class="perms_unchecked"
                                                                        name="perms_unchecked[]"
                                                                        data-unchecked-id="{{ $sub_perm->id }}"
                                                                        value="">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input check-demo"
                                                                            data-id="{{ $sub_perm->id }}"
                                                                            @if ($role->hasPermissionById($sub_perm->id)) checked @endif
                                                                            name="perms[]" type="checkbox"
                                                                            id="{{ $sub_perm->slug }}"
                                                                            value="{{ $sub_perm->id }}">
                                                                        {{ $sub_perm->name }}
                                                                    </label>
