...
@section('title')Edit Combo Product @endsection
  ...
  <section>
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="card" id="products-list" style="height: 100vh; overflow-y: auto;">
        ...
        <div class="col-md-7">
            <form action="{{ route('editComboPost', $product->unique_key) }}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <table class="table table-borderless" id="comboTable">
                            ...
                            <tbody id="comboTableBody">
                                @php
                                    $total_purchase = 0;
                                @endphp
                                @foreach ($product->comboProducts() as $pro)
                                <tr>

                                    <td>
                                        <input type="hidden" class="row_product_id" value="{{ $pro->id }}">
                                        <input type="hidden" name="idQty[]" class="row_product_idQty" value="{{ $pro->id.'-'.$pro->quantity_combined }}">{{ $pro->name }}
                                    </td>
                                    <td>
                                        <input type="hidden" class="row_product_purchaseprice" value="{{ $pro->purchase_price * $pro->quantity_combined }}">
                                        <span class="currency">₦</span><span class="product_unitprice">{{ $pro->sale_price }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="input-group input-spinner mb-3">
                                            ...
                                            <input style="max-width: 50px; min-width: 50px;" class="form-control form-control-sm border text-center product_quantity" placeholder="" value="{{ $pro->quantity_combined }}" min="1">
                                    ...
                                    <td><span class="currency">₦</span><span class="product_subtotal">{{ $pro->sale_price * $pro->quantity_combined }}</span></td>
                                    <td><button class="btn btn-danger btn-sm bi bi-x btnDelete"></button></td>
                                    @php
                                        $total_purchase += $pro->purchase_price * $pro->quantity_combined;
                                    @endphp
                                </tr>
                                @endforeach
                                
                            </tbody>
                            <input type="hidden" name="total_before_discount" id="total_before_discount_input" value="{{ $product->comboOriginalSalePrice() }}">
                            <input type="hidden" name="total_after_discount" id="total_after_discount_input" value="{{ $product->sale_price }}">
                            <input type="hidden" name="total_purchase" id="total_purchase" value="{{ $total_purchase }}">
                        </table>
                    </div>
                </div>
                    ...
                    <div class="card-body pt-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <select name="discount_type" id="discount_type" class="form-control @error('discount_type') is-invalid @enderror">
                                        <option value="{{ $product->discount_type  }}" selected>{{ ucFirst($product->discount_type) }}</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="discount_value" id="discount_value" class="form-control @error('discount_value') is-invalid @enderror" value="{{ $product->discount }}">
                                ...
                                <div class="col-md-6">
                                    <label for="">Change Combo Image</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea name="short_description" id="" cols="30" rows="1" class="form-control @error('short_description') is-invalid @enderror">{{ isset($product->short_description) ? $product->short_description : '' }}</textarea>
                ...
                <div class="card bg-medium">
                    <div class="card-body p-2">
                        <div class="card-title">
                            <div class="row">
                                <div class="col-md-4"><h6>Total Before Discount:<br> <b class="currency">₦</b><span class="total_before_discount" style="color:inherit; font-size: 16px;">{{ $product->comboOriginalSalePrice() }}</span></h6></div>
                                <div class="col-md-4"><h6>Total After Discount:<br> <b class="currency">₦</b><span class="total_after_discount" style="color:inherit; font-size: 16px;">{{ $product->sale_price }}</span></h6></div>
