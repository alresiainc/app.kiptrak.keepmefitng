                ...
                <div class="col-md-5">
                    ...
                    <div class="card" id="products-list" style="overflow-y:auto">
                        <div class="card-body pt-3 ">
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 style="font-size: 12px !important; text-transform: uppercase; color:#000;">Click on
                                        any product to add as combo</h5>
                                </div>
                            </div>
                            <hr>

                            <div>
                                <input type="search" id="product_filter" class="form-control rounded-pill"
                            ...
                            <div class="row">
                                ...
                                @if (count($products) > 0)
                                    @foreach ($products as $product)
                                        <div class="col-md-3 p-0 each_item" data-product_id="{{ $product->id }}"
                                            data-product_name="{{ $product->name }}"
                                            data-product_saleprice="{{ $product->sale_price }}"
                                            data-product_purchaseprice="{{ $product->purchase_price }}">
                                            <div class="card">
                                                <div
                                                    class="card-body text-center pt-2
                                    px-1">
                                                    <div class="image">
                                                    ...
                                                    <div class="small"><small
                                                            class="text-dark">{{ $product->name }}</small></div>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="card" style="height: 50vh; overflow-y: auto;">
                            <div class="card-body">
                                <table class="table table-borderless" id="comboTable">
                                    ...
                                    <input type="hidden" name="total_before_discount" id="total_before_discount_input"
                                        value="">
                                    <input type="hidden" name="total_after_discount" id="total_after_discount_input"
                                        value="">
                            ...
                            <div class="card-body pt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select name="discount_type" id="discount_type"
                                                ...
                                                <option value="{{ old('discount_type') ? old('discount_type') : 'fixed' }}"
                                                    selected>{{ old('discount_type') ? old('discount_type') : 'Fixed' }}
                                                </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <textarea name="short_description" id="" cols="30" rows="1"
                                            class="form-control @error('category') is-invalid @enderror"></textarea>
                                        @error('category')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="card bg-medium">
                            <div class="card-body p-2">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h6>Total Before Discount:<br> <b class="currency">₦</b><span
                                                    class="total_before_discount"
                                                    style="color:inherit; font-size: 16px;">0.00</span></h6>
                                        </div>
                                        <div class="col-md-4">
                                            <h6>Total After Discount:<br> <b class="currency">₦</b><span
...
@section('extra_js')
            ...
            if (file) {
                ...
                if (file.size > 2 * 1024 * 1024) {
                    ...
                    errorElement.textContent =
                        'The selected file exceeds the 2 MB size limit. Please choose a smaller file.';
    ...
    <script>
        $(".each_item").click(function() {
            ...
            var productName = '<td><input type="hidden" class="row_product_id" value="' + product_id +
                '"><input type="hidden" name="idQty[]" class="row_product_idQty" value="' + idQty + '">' +
                product_name + '</td>';
            var productSalePrice = '<td><input type="hidden" class="row_product_purchaseprice" value="' +
                product_purchaseprice + '"><span class="currency">₦</span><span class="product_unitprice">' +
                product_saleprice + '</span></td>';
            ...
            var productSubTotal = '<td><span class="currency">₦</span><span class="product_subtotal">' +
                product_saleprice + '</span></td>';
