...
@section('title')Supplier Report @endsection
...
<main id="main" class="main">
  ...
  <section class="users-list-wrapper">
    <div class="users-list-filter px-1">
      <form action="{{ route('supplierReportQuery') }}" method="POST">@csrf
        <div class="row border rounded py-2 mb-2">
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-3">
            ...
            <fieldset class="form-group">
              <select name="supplier_id" data-live-search="true" class="custom-select border form-control" id="">
                <option value="{{ $supplier_selected != '' ? $supplier_selected->id : '' }}">{{ $supplier_selected != '' ? $supplier_selected->company_name : 'Nothing Selected' }}</option>
                @if (count($suppliers))
        ...
        <div class="card">
          ...
          <div class="table table-responsive">
            ...
            <table id="products-table" class="table custom-table" style="width:100%">
                ...
                <tbody>
                  @if (count($supplier_purchases) > 0)
                  <?php $supplierTotalPaid = 0; ?>
                      @foreach ($supplier_purchases as $purchase)
                          ...
                          <?php $supplierTotalPaid += $purchase->amountPaidAccrued($purchase->purchase_code); ?>
                      @endforeach
                      <input type="hidden" id="supplierTotalPaid" value="{{ $supplierTotalPaid }}">
                  @endif
...
<!--Modal-->
<div class="modal fade" id="supplierReportModal" tabindex="-1" aria-labelledby="supplierReportModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Select Supplier to See Report</h1>
...
@section('extra_js')
    <script>
        $supplierTotalPaid = $("#supplierTotalPaid").val();
        $(".totalPaid").text($supplierTotalPaid);
    </script>
@endsection