...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Whatsapp Sent Messages: @if ($order !== '')
                    <span class="text-dark">{{ $order->customer->firstname . ' ' . $order->customer->lastname }}</span>
                @endif
            </h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <a href="{{ route('viewMessageTemplates', 'whatsapp') }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (isset($message->to) && $message->to == 'customers')
                                                            @foreach ($customers as $customer)
                                                                <span
                                                                    class="badge badge-dark mr-1">{{ $customer->whatsapp_phone_number }}</span>
                                                            @endforeach
                                                        @endif
