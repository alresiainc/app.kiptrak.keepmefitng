...
@section('title')Compose Message For {{ $category->name }} Customers @endsection
@section('extra_css')
    <style>
        select{
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Compose Message For {{ $category->name }} Customers</h1>
      <nav>
        <ol class="breadcrumb">
        ...
        <div class="clearfix mb-2">
            ...
            <div class="float-start text-start">
                @foreach ($selectedCustomers as $customer)
                    <span class="badge badge-dark">{{ $customer->email }}</span>
                @endforeach
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form id="messageForm" class="row g-3 needs-validation" action="{{ route('mailCustomersByCategory', [$category->unique_key, $recipients]) }}" method="POST"
