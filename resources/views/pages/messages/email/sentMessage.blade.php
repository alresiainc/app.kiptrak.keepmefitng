                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @if (isset($message->to) && $message->to=='customers')
                                ...
                                <span class="badge badge-dark mr-1">{{ $customer->email }}</span>
                                @endforeach
                              @endif
                            ...
                            <td>{{ substr($message->message, 0, 30) . '...' }} <br>
                              <span class="badge badge-dark" onclick="editSentMailModal('{{ $message->id }}', '{{ $message->topic }}', '{{ $message->message }}')" style="cursor: pointer;">view more</span></td>
