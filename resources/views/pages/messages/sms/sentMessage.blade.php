        ...
        <div class="card">
          ...
          <div class="clearfix mb-2">
            <div class="float-start text-start">
                <a href="{{ route('composeSmsMessage') }}"><button class="btn btn-sm btn-dark rounded-pill" data-bs-toggle="tooltip" data-bs-placement="auto" data-bs-title="Compose Message">
