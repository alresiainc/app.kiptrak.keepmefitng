                ...
                @if (count($expenses) > 0)
                    @foreach ($expenses as $expense)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                <a href="{{ route('singleExpense', $expense->unique_key) }}" class="btn btn-primary btn-sm me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View"><i class="bi bi-eye"></i></a>
