                            ...
                            <form action="">@csrf
                                ...
                                <div class="row">
                                        ...
                                        @if ($contact['form_name'] != 'product-package')
                                            <div class="col-lg-6 mb-3 contact-parent">
                                                ...
                                                @if ($contact['form_type'] == 'text_field')
                                                    <input
                                                        type="{{ $contact['form_name'] == 'active-email' ? 'email' : 'text' }}"
                                                        ...
                                                        @if ($contact['form_name'] != 'active-email') required @endif>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="" class="form-label"><b>Select how long you want the order
                                                to be delivered *</b></label>
                                        <select data-name="delivery_duration"
                                            class="delivery_duration select2 form-control border @error('delivery_duration') is-invalid @enderror"
                                            id="">
                                    ...
                                    @foreach ($products as $key => $item)
                                        <div class="col-12 mb-3">
                                            <label for="package{{ $key }}"
                                                class="product_package_label form-label btn btn-outline border d-flex align-items-center me-3 @error($item['form_name']) is-invalid @enderror">
                                                <input
                                                    type="{{ $item['form_type'] == 'package_single' ? 'radio' : 'checkbox' }}"
                                                    name="product_packages[]" id="package{{ $key }}"
                                                    class="me-3 product-package"
                                                    value="{{ $item['id'] }}-{{ $item['price'] }}" />
                                                <span class="me-1 fw-bold">{{ $item['name'] }} = {{ $item['price'] }}
                                                    naira</span>

                                                <select name="select_product_qty"
                                                    class="select_product_qty custom-select form-control"
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center">
                                            <button type="button"
                                                class="btn rounded-pill w-50 p-2 text-white main_package_submit_btn"
                                                style="background-color: #04512d">Submit Order</button>
                                        </div>
                                    </div>
