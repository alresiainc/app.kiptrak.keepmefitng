...
@section('title')Edit ThankYou Template @endsection
@section('extra_css')
    <style>
        select{
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{ route('editThankYouTemplatePost', $thankYou->unique_key) }}" method="POST">@csrf
              <div class="col-md-12 mb-3">The field labels marked with * are required input fields.</div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="template_name" class="form-control @error('template_name') is-invalid @enderror" value="{{ $thankYou->template_name }}">
                    @error('template_name')
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" name="body_bg_color" class="form-control @error('body_bg_color') is-invalid @enderror" value="{{ $thankYou->body_bg_color }}">
                  @error('body_bg_color')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_style" id="body_border_style" data-live-search="true" class="custom-select form-control border @error('sale_status') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->body_border_style }}" selected>{{ $thankYou->body_border_style }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="body_border_color" class="form-control @error('body_border_color') is-invalid @enderror" value="#ffffff">
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_thickness" id="body_border_thickness" data-live-search="true" class="custom-select form-control border @error('body_border_thickness') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->body_border_thickness }}" selected>{{ $thankYou->body_border_thickness }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_radius" id="body_border_radius" data-live-search="true" class="custom-select form-control border @error('body_border_radius') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->body_border_radius }}" selected>{{ $thankYou->body_border_radius }}</option>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="heading_text" class="form-control @error('heading_text') is-invalid @enderror" value="{{ $thankYou->heading_text }}" >
                    @error('heading_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4">
                    ...
                    <select name="heading_text_style" id="header_text_style" data-live-search="true" class="custom-select form-control border @error('heading_text_style') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->header_text_style }}" selected>{{ $thankYou->header_text_style }}</option>
                      <option value="normal">normal</option>
                ...
                <div class="col-md-4">
                    ...
                    <select name="heading_text_align" id="heading_text_align" data-live-search="true" class="custom-select form-control border @error('heading_text_align') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->heading_text_align }}" selected>{{ $thankYou->heading_text_align }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="heading_text_color" class="form-control @error('heading_text_color') is-invalid @enderror" value="{{ $thankYou->heading_text_color }}" >
                ...
                <div class="col-md-6">
                    ...
                    <select name="heading_text_weight" id="heading_text_weight" data-live-search="true" class="custom-select form-control border @error('heading_text_weight') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->heading_text_weight }}" selected>{{ ucFirst($thankYou->heading_text_weight) }}</option>
                      <option value="normal">Normal</option>
                ...
                <div class="col-md-6">
                    ...
                    <select name="heading_text_size" id="heading_text_size" data-live-search="true" class="custom-select form-control border @error('heading_text_size') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->heading_text_size }}" selected>Size-{{ $thankYou->heading_text_size }}</option>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="subheading_text" class="form-control @error('subheading_text') is-invalid @enderror" value="{{ $thankYou->subheading_text }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="subheading_text_style" id="subheading_text_style" data-live-search="true" class="custom-select form-control border @error('subheading_text_style') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->subheading_text_style }}" selected>{{ $thankYou->subheading_text_style }}</option>
                      <option value="normal">normal</option>
                      <option value="italic">italic</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="subheading_text_align" id="subheading_text_align" data-live-search="true" class="custom-select form-control border @error('subheading_text_align') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->subheading_text_align }}" selected>{{ ucFirst($thankYou->subheading_text_align) }}</option>
                      <option value="left">left</option>
                      <option value="right">right</option>
                      <option value="center">center</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="subheading_text_color" class="form-control @error('subheading_text_color') is-invalid @enderror" placeholder="" value="{{ $thankYou->subheading_text_color }}">
                ...
                <div class="col-md-6">
                    ...
                    <select name="subheading_text_weight" id="subheading_text_weight" data-live-search="true" class="custom-select form-control border @error('subheading_text_weight') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->subheading_text_weight }}" selected>{{ ucFirst($thankYou->subheading_text_weight) }}</option>
                      <option value="normal">Normal</option>
                      <option value="bold">Bold</option>
                      <option value="bolder">Bolder</option>
                      <option value="light">Light</option>
                ...
                <div class="col-md-6">
                    ...
                    <select name="subheading_text_size" id="subheading_text_size" data-live-search="true" class="custom-select form-control border @error('subheading_text_size') is-invalid @enderror" id="">
                      <option value="{{ $thankYou->subheading_text_size }}" selected>Size-{{ $thankYou->subheading_text_size }}</option>
                      <option value="1">Size-1 largest</option>
                      <option value="2">Size-2</option>
                      <option value="3">Size-3</option>
                      <option value="4">Size-4</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="button_text" class="form-control @error('button_text') is-invalid @enderror" placeholder="" value="{{ $thankYou->button_text }}">
                        @error('button_text')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Background Color</label>
                        <input type="color" name="button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" placeholder="" value="{{ $thankYou->button_bg_color }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="button_text_style" id="button_text_style" data-live-search="true" class="custom-select form-control border @error('button_text_style') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->button_text_style }}" selected>{{ $thankYou->button_text_style }}</option>
                          <option value="normal">normal</option>
                          <option value="italic">italic</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="button_text_align" id="button_text_align" data-live-search="true" class="custom-select form-control border @error('button_text_align') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->button_text_align }}" selected>{{ $thankYou->button_text_align }}</option>
                          <option value="left">left</option>
                          <option value="right">right</option>
                          <option value="center">center</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="color" name="button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" value="{{ $thankYou->button_text_color }}" >
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="button_text_weight" id="button_text_weight" data-live-search="true" class="custom-select form-control border @error('button_text_weight') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->button_text_weight }}" selected>{{ ucFirst($thankYou->button_text_weight) }}</option>
                          <option value="normal">Normal</option>
                          <option value="bold">Bold</option>
                          <option value="bolder">Bolder</option>
                          <option value="light">Light</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="button_text_size" id="button_text_size" data-live-search="true" class="custom-select form-control border @error('button_text_size') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->button_text_size }}" selected>Size-{{ $thankYou->button_text_size }}</option>
                          <option value="1">Size-1 largest</option>
                          <option value="2">Size-2</option>
                          <option value="3">Size-3</option>
                          <option value="4">Size-4</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Background Color</label>
                        <input type="color" name="onhover_button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" placeholder="" value="{{ $thankYou->onhover_button_bg_color }}">
                        @error('button_bg_color')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Border Color</label>
                        <input type="color" name="onhover_button_border_color" class="form-control @error('onhover_button_border_color') is-invalid @enderror" placeholder="" value="{{ $thankYou->onhover_button_border_color }}">
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Text Style</label>
                        <select name="onhover_button_text_style" id="button_text_style" data-live-search="true" class="custom-select form-control border @error('button_text_style') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->onhover_button_text_style }}" selected>{{ $thankYou->onhover_button_text_style }}</option>
                          <option value="normal">normal</option>
                          <option value="italic">italic</option>
                        </select>
                        @error('button_text_style')
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Text Color</label>
                        <input type="color" name="onhover_button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" value="{{ $thankYou->onhover_button_text_color }}" >
                        @error('button_text_color')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        <label for="" class="form-label">Text Thickness</label>
                        <select name="onhover_button_text_weight" id="button_text_weight" data-live-search="true" class="custom-select form-control border @error('button_text_weight') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->onhover_button_text_weight }}" selected>{{ ucFirst($thankYou->onhover_button_text_weight) }}</option>
                          <option value="normal">Normal</option>
                          <option value="bold">Bold</option>
                          <option value="bolder">Bolder</option>
                          <option value="light">Light</option>
                    ...
                    <div class="col-md-6">
                        <label for="" class="form-label">Text Size</label>
                        <select name="onhover_button_text_size" id="button_text_size" data-live-search="true" class="custom-select form-control border @error('button_text_size') is-invalid @enderror" id="">
                          <option value="{{ $thankYou->onhover_button_text_size }}" selected>Size-{{ $thankYou->onhover_button_text_size }}</option>
                          <option value="1">Size-1 largest</option>
                          <option value="2">Size-2</option>
                          <option value="3">Size-3</option>
                          <option value="4">Size-4</option>
