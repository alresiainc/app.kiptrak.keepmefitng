...
@section('title')Create ThankYou Template @endsection
@section('extra_css')
    <style>
        select{
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Create ThankYou Template</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{ route('addThankYouTemplatePost') }}" method="POST">@csrf
              <div class="col-md-12 mb-3">The field labels marked with * are required input fields.</div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="template_name" class="form-control @error('template_name') is-invalid @enderror" value="{{ old('template_name') }}">
                    @error('template_name')
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" name="body_bg_color" class="form-control @error('body_bg_color') is-invalid @enderror" value="#ffffff">
                  @error('body_bg_color')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="heading_text" class="form-control @error('heading_text') is-invalid @enderror" value="Thank you for your order" >
                    @error('heading_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="subheading_text" class="form-control @error('subheading_text') is-invalid @enderror" value="We have received your order confirmation. One of our agents will contact you shortly.">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="button_text" class="form-control @error('button_text') is-invalid @enderror" placeholder="" value="Download Invoice">
                        @error('button_text')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Background Color</label>
                        <input type="color" name="onhover_button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" placeholder="" value="#ffffff">
                        @error('button_bg_color')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Border Color</label>
                        <input type="color" name="onhover_button_border_color" class="form-control @error('onhover_button_border_color') is-invalid @enderror" placeholder="" value="#ffffff">
                    ...
                    <div class="col-md-3">
                        <label for="" class="form-label">Text Color</label>
                        <input type="color" name="onhover_button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" value="#04512d" >
                        @error('button_text_color')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
