                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" action="{{ route('addThankYouTemplatePost') }}"
                                method="POST">@csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="body_bg_color"
                                        class="form-control @error('body_bg_color') is-invalid @enderror" value="#ffffff">
                                    @error('body_bg_color')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="button_text"
                                            ...
                                            placeholder="" value="Download Invoice">
                                        @error('button_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
