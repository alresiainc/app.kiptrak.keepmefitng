        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{ route('addUpsellTemplatePost') }}" method="POST"
              ...
              <div class="col-md-12 mb-3">The field labels marked with * are required input fields.</div>
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" name="body_bg_color" class="form-control @error('body_bg_color') is-invalid @enderror" value="#000000">
                  @error('body_bg_color')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="heading_text" class="form-control @error('heading_text') is-invalid @enderror" placeholder="" >
                    @error('heading_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="heading_text_color" class="form-control @error('heading_text_color') is-invalid @enderror" placeholder="" >
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="subheading_text" class="form-control @error('subheading_text') is-invalid @enderror" placeholder="" >
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="description_text" class="form-control @error('description_text') is-invalid @enderror" placeholder="" >
                ...
                <div class="col-md-4">
                    ...
                    <select name="description_text_align" id="description_text_align" data-live-search="true" class="custom-select form-control border @error('description_text_align') is-invalid @enderror" id="">
                      <option value="normal" selected>left</option>
                      <option value="right">right</option>
                      <option value="center">center</option>
                    </select>
                ...
                <div class="col-md-3">
                    <label for="" class="form-label">Background Color</label>
                    <input type="color" name="button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" placeholder="" value="#000000">
                ...
                <div class="col-md-3">
                    <label for="" class="form-label">Text Color</label>
                    <input type="color" name="button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" placeholder="" >
