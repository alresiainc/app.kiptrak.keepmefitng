...
@section('title')Edit UpSell Template @endsection
@section('extra_css')
    <style>
        select{
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{ route('editUpsellTemplatePost', $upsellTemplate->unique_key) }}" method="POST"
              ...
              <div class="col-md-12 mb-3">The field labels marked with * are required input fields.</div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="template_code" class="form-control @error('template_code') is-invalid @enderror" value="{{ $upsellTemplate->template_code }}" readonly>
                    @error('template_code')
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" name="body_bg_color" class="form-control @error('body_bg_color') is-invalid @enderror" value="{{ $upsellTemplate->body_bg_color }}">
                  @error('body_bg_color')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_style" id="body_border_style" data-live-search="true" class="custom-select form-control border @error('sale_status') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->body_border_style }}" selected>{{ $upsellTemplate->body_border_style }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="body_border_color" class="form-control @error('body_border_color') is-invalid @enderror" value="{{ $upsellTemplate->body_border_color }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_thickness" id="body_border_thickness" data-live-search="true" class="custom-select form-control border @error('body_border_thickness') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->body_border_thickness }}" selected>{{ $upsellTemplate->body_border_thickness }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <select name="body_border_radius" id="body_border_radius" data-live-search="true" class="custom-select form-control border @error('body_border_radius') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->body_border_radius }}" selected>{{ $upsellTemplate->body_border_radius }}</option>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="heading_text" class="form-control @error('heading_text') is-invalid @enderror" placeholder="" value="{{ $upsellTemplate->heading_text }}">
                    @error('heading_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4">
                    ...
                    <select name="heading_text_style" id="header_text_style" data-live-search="true" class="custom-select form-control border @error('heading_text_style') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->heading_text_style }}" selected>{{ $upsellTemplate->heading_text }}</option>
                      <option value="normal">normal</option>
                ...
                <div class="col-md-4">
                    ...
                    <select name="heading_text_align" id="heading_text_align" data-live-search="true" class="custom-select form-control border @error('heading_text_align') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->heading_text_align }}" selected>{{ $upsellTemplate->heading_text_align }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="heading_text_color" class="form-control @error('heading_text_color') is-invalid @enderror" value="{{ $upsellTemplate->heading_text_color }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="subheading_text_style" id="subheading_text_style" data-live-search="true" class="custom-select form-control border @error('subheading_text_style') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->subheading_text_style }}" selected>{{ $upsellTemplate->subheading_text_style }}</option>
                      <option value="normal">normal</option>
                      <option value="italic">italic</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="subheading_text_align" id="subheading_text_align" data-live-search="true" class="custom-select form-control border @error('subheading_text_align') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->subheading_text_align }}" selected>{{ $upsellTemplate->subheading_text_align }}</option>
                      <option value="left">left</option>
                      <option value="right">right</option>
                      <option value="center">center</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="subheading_text_color" class="form-control @error('subheading_text_color') is-invalid @enderror" value="{{ $upsellTemplate->subheading_text_color }}" >
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="description_text" class="form-control @error('description_text') is-invalid @enderror" value="{{ $upsellTemplate->description_text }}" >
                ...
                <div class="col-md-4">
                    ...
                    <select name="description_text_style" id="description_text_style" data-live-search="true" class="custom-select form-control border @error('description_text_style') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->description_text_style }}" selected>{{ $upsellTemplate->description_text_style }}</option>
                      <option value="normal">normal</option>
                      <option value="italic">italic</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="description_text_align" id="description_text_align" data-live-search="true" class="custom-select form-control border @error('description_text_align') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->description_text_align }}" selected>{{ $upsellTemplate->description_text_align }}</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="color" name="description_text_color" class="form-control @error('description_text_color') is-invalid @enderror" value="{{ $upsellTemplate->description_text_color }}" >
                ...
                <div class="col-md-4">
                    ...
                    <select name="package_text_style" id="package_text_style " data-live-search="true" class="custom-select form-control border @error('package_text_style ') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->package_text_style }}" selected>{{ $upsellTemplate->package_text_style }}</option>
                      <option value="normal">normal</option>
                      <option value="italic">italic</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="package_text_align" id="package_text_align" data-live-search="true" class="custom-select form-control border @error('package_text_align') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->package_text_align }}" selected>{{ $upsellTemplate->package_text_align }}</option>
                      <option value="normal">left</option>
                      <option value="right">right</option>
                      <option value="center">center</option>
                    </select>
                ...
                <div class="col-md-4">
                    <label for="" class="form-label">Text Color</label>
                    <input type="color" name="package_text_color" class="form-control @error('package_text_color') is-invalid @enderror" value="{{ $upsellTemplate->package_text_color }}" >
                ...
                <div class="col-md-12">
                    <label for="" class="form-label">Text</label>
                    <input type="text" name="button_text" class="form-control @error('button_text') is-invalid @enderror" placeholder="" value="{{ $upsellTemplate->button_text }}">
                    @error('button_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-3">
                    <label for="" class="form-label">Background Color</label>
                    <input type="color" name="button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" placeholder="" value="{{ $upsellTemplate->button_bg_color }}">
                ...
                <div class="col-md-3">
                    ...
                    <select name="button_text_style" id="button_text_style" data-live-search="true" class="custom-select form-control border @error('button_text_style') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->button_text_style }}" selected>{{ $upsellTemplate->button_text_style }}</option>
                      <option value="normal">normal</option>
                      <option value="italic">italic</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="button_text_align" id="button_text_align" data-live-search="true" class="custom-select form-control border @error('button_text_align') is-invalid @enderror" id="">
                      <option value="{{ $upsellTemplate->button_text_align }}" selected>{{ $upsellTemplate->button_text_align }}</option>
                      <option value="normal">left</option>
                      <option value="right">right</option>
                      <option value="center">center</option>
                    </select>
                ...
                <div class="col-md-3">
                    <label for="" class="form-label">Text Color</label>
                    <input type="color" name="button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" value="{{ $upsellTemplate->button_text_color }}" >
