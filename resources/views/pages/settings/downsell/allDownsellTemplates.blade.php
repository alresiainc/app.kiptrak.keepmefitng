...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Downsell Templates</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active">Downsell Templates</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="clearfix mb-2">
                                ...
                                <div class="float-start text-start">
                                    <a href="{{ route('addDownsellTemplate') }}"><button
                                        ...
                                        @if (count($downsellTemplates) > 0)
                                            @foreach ($downsellTemplates as $template)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{ route('singleDownsellTemplate', $template->unique_key) }}"
                                                                class="btn btn-primary btn-sm me-2" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" data-bs-title="View"><i
                                                                    class="bi bi-eye"></i></a>
                                                            <a href="{{ route('editDownsellTemplate', $template->unique_key) }}"
