                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" action="{{ route('addDownsellTemplatePost') }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="body_bg_color"
                                        class="form-control @error('body_bg_color') is-invalid @enderror" value="#ead7d7">
                                    @error('body_bg_color')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12 d-none">
                                    ...
                                    <input type="text" name="subheading_text2"
                                        class="form-control d-none @error('subheading_text') is-invalid @enderror"
                                        value="We're giving this at a giveaway price">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="description_text"
                                        ...
                                        value="This will cost less, as you buy with the package">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="header_scripts" name="header_scripts" class="form-control" rows="5">{{ old('header_scripts') }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="footer_scripts" name="footer_scripts" class="form-control" rows="5">{{ old('footer_scripts') }}</textarea>
