                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation"
                                action="{{ route('editDownsellTemplatePost', $downsellTemplate->unique_key) }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="template_code"
                                        ...
                                        value="{{ $downsellTemplate->template_code }}" readonly>
                                    @error('template_code')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="body_bg_color"
                                        ...
                                        value="{{ $downsellTemplate->body_bg_color }}">
                                    @error('body_bg_color')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="body_border_style" id="body_border_style" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->body_border_style }}" selected>
                                            {{ $downsellTemplate->body_border_style }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="body_border_color"
                                        ...
                                        value="{{ $downsellTemplate->body_border_color }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="body_border_thickness" id="body_border_thickness" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->body_border_thickness }}" selected>
                                            {{ $downsellTemplate->body_border_thickness }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="body_border_radius" id="body_border_radius" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->body_border_radius }}" selected>
                                            {{ $downsellTemplate->body_border_radius }}</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="heading_text"
                                        ...
                                        value="{{ $downsellTemplate->heading_text }}">
                                    @error('heading_text')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="heading_text_style" id="header_text_style" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->heading_text_style }}" selected>
                                            {{ $downsellTemplate->heading_text }}</option>
                                        <option value="normal">normal</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="heading_text_align" id="heading_text_align" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->heading_text_align }}" selected>
                                            {{ $downsellTemplate->heading_text_align }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="heading_text_color"
                                        ...
                                        value="{{ $downsellTemplate->heading_text_color }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="subheading_text_style" id="subheading_text_style"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->subheading_text_style }}" selected>
                                            {{ $downsellTemplate->subheading_text_style }}</option>
                                        <option value="normal">normal</option>
                                        <option value="italic">italic</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="subheading_text_align" id="subheading_text_align"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->subheading_text_align }}" selected>
                                            {{ $downsellTemplate->subheading_text_align }}</option>
                                        <option value="left">left</option>
                                        <option value="right">right</option>
                                        <option value="center">center</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="subheading_text_color"
                                        ...
                                        value="{{ $downsellTemplate->subheading_text_color }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="description_text"
                                        ...
                                        value="{{ $downsellTemplate->description_text }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="description_text_style" id="description_text_style"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->description_text_style }}" selected>
                                            {{ $downsellTemplate->description_text_style }}</option>
                                        <option value="normal">normal</option>
                                        <option value="italic">italic</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="description_text_align" id="description_text_align"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->description_text_align }}" selected>
                                            {{ $downsellTemplate->description_text_align }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="description_text_color"
                                        ...
                                        value="{{ $downsellTemplate->description_text_color }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="package_text_style" id="package_text_style " data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->package_text_style }}" selected>
                                            {{ $downsellTemplate->package_text_style }}</option>
                                        <option value="normal">normal</option>
                                        <option value="italic">italic</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="package_text_align" id="package_text_align" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->package_text_align }}" selected>
                                            {{ $downsellTemplate->package_text_align }}</option>
                                        <option value="normal">left</option>
                                        <option value="right">right</option>
                                        <option value="center">center</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="color" name="package_text_color"
                                        ...
                                        value="{{ $downsellTemplate->package_text_color }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="button_text"
                                        ...
                                        value="{{ $downsellTemplate->button_text }}">
                                    @error('button_text')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="color" name="button_bg_color"
                                        ...
                                        placeholder="" value="{{ $downsellTemplate->button_bg_color }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="button_text_style" id="button_text_style" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->button_text_style }}" selected>
                                            {{ $downsellTemplate->button_text_style }}</option>
                                        <option value="normal">normal</option>
                                        <option value="italic">italic</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="button_text_align" id="button_text_align" data-live-search="true"
                                        ...
                                        id="">
                                        <option value="{{ $downsellTemplate->button_text_align }}" selected>
                                            {{ $downsellTemplate->button_text_align }}</option>
                                        <option value="normal">left</option>
                                        <option value="right">right</option>
                                        <option value="center">center</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="color" name="button_text_color"
                                        ...
                                        value="{{ $downsellTemplate->button_text_color }}">
