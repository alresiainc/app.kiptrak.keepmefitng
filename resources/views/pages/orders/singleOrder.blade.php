          ...
          <div class="card">
            ...
            <div class="row g-3 m-1">
                ...
                <div class="col-lg-3 col-md-12 extra_options">
                    ...
                    onclick="changeStaffModal('{{ $order->id }}')" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Change Staff">Change Staff</div>
                    @else
                    <div class="badge badge-dark" 
                    onclick="addStaffModal('{{ $order->id }}')" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Assign Staff">Assign Staff</div>
                    @endif
                </div>
                <div class="col-lg-3 col-md-12 extra_options">
                    @if (isset($order->agent_assigned_id))
                    <div class="badge badge-dark" 
                    onclick="changeAgentModal('{{ $order->id }}')" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Change Agent">Change Agent</div>
                    @else
                    <div class="badge badge-dark" 
                    onclick="addAgentModal('{{ $order->id }}')" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Assign Agent">Assign Agent</div>
                    @endif
                </div>
                <div class="col-lg-3 col-md-12 extra_options">
                    <div class="badge badge-dark" data-bs-toggle="modal" data-bs-target="#extraCostModal">Update Extra Cost</div>
                </div>
            </div>
            <hr>
            <div class="row g-3 m-1">
                ...
                <div class="col-lg-5">
                    ...
                    <div>Phone:  <span class="lead">@if($order->customer_id) <a href="tel:{{$order->customer->phone_number}}">{{$order->customer->phone_number}}</a> @else N/A @endif</span><br>
            ...
            <div class="row g-3 m-1">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="text-dark" style="font-size: 14px;">{{ $package->amount_accrued }}</div>
                </div>
...
<!-- Modal extraCost -->
<div class="modal fade" id="extraCostModal" tabindex="-1" aria-labelledby="extraCostModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('extraCostToOrder') }}" method="POST">@csrf
                <div class="modal-body">
                    ...
                    <input type="hidden" id="order_id" class="order_id" name="order_id" value="{{ $order->id }}">
                    <div class="d-grid mb-3">
                        <label for="">Amount ({{ $currency }})</label>
                        <input type="text" name="extra_cost_amount" class="extra_cost_amount form-control @error('extra_cost_amount') is-invalid @enderror"
                        id="" value="{{ isset($order->extra_cost_amount) ? $order->extra_cost_amount : 0 }}">
                    </div>
                    ...
                    <div class="form-check">
                        <input name="remove" id="remove" class="form-check-input" type="checkbox" value="1">
