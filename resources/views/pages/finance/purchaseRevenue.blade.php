...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Purchase Revenue</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
        <li class="breadcrumb-item active">Purchase Revenue</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
                ...
                @if (count($purchases) > 0)
                    @foreach ($purchases as $purchase)
                        ...
                        <tr>
                            ...
                            <td>{{ $purchase->product_purchase_price * $purchase->product_qty_purchased }}</td>
                            <td>{{ isset($purchase->purchase_date) ? $purchase->purchaseDate() : $purchase->created_at }}</td>
                        </tr>
