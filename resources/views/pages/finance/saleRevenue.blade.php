...
@section('title')Account: Sales Revenue @endsection
@section('content')
                ...
                @if (count($sales) > 0)
                    @foreach ($sales as $sale)
                        ...
                        <tr>
                            ...
                            <td>{{ $sale->product_selling_price * $sale->product_qty_sold }}</td>
                            <td>{{ isset($sale->sale_date) ? $sale->saleDate() : $sale->created_at }}</td>
                        </tr>
