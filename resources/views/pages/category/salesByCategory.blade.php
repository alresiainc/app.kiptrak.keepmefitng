...
@section('title'){{ $category->name }}, Sales Inventory @endsection
@section('content')

<main id="main" class="main">

  <div class="pagetitle">
    <h1>{{ $category->name }}, Sales Inventory</h1>
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ $category->name }}, Sales Record</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
