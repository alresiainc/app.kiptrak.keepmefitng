...
function kiptrak_shortcode($atts)
{
    ...
    if ($type === 'form') {
        ...
        $iframe_url = rtrim(trailingslashit($site_url), '/') . '/integration/get-form';
        ...
        // If the response is not 200, or the JSON is invalid, display the error message from the site
